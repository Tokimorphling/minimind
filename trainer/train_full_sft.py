...
if __name__ == "__main__":
    ...
    parser.add_argument('--optimizer', default="adamw", type=str, choices=['adamw', 'muon'])
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MiniMind-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}-Opt-{args.optimizer}"
